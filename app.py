...
def main():
    ...
    # ─── FORCE HORIZONTAL LAYOUT VIA JAVASCRIPT (overrides everything) ───
    st.markdown("""
    <script>
    (function() {
        function forceHorizontal() {
            ...
            // Force tabs to be horizontal scrollable
            const tabLists = document.querySelectorAll('.stTabs [role="tablist"]');
            ...
            // Force top nav to be horizontal scrollable
            const topNav = document.querySelector('.top-nav');
            if (topNav) {
                topNav.style.display = 'flex';
                topNav.style.flexWrap = 'nowrap';
                topNav.style.overflowX = 'auto';
                topNav.style.webkitOverflowScrolling = 'touch';
            }
        }
