...
<style>
    ...
    /* On mobile, make columns shrink but stay in a row */
    @media (max-width: 768px) {
        /* Prevent columns from stacking – keep them in a row */
        ...
        /* Specifically target dashboard action buttons */
        ...
        /* Reduce font sizes and paddings so everything fits */
        ...
        /* Ensure expanders, metrics, and dataframes don't overflow */
        .stExpander { width: 100% !important; }
        .stDataFrame { overflow-x: auto !important; }
        .stMetric { text-align: center !important; }
        /* Cards and containers fill the screen */
        ...
        /* Remove extra padding from the main area when sidebar is collapsed */
        section[data-testid="stSidebar"][aria-expanded="false"] + section {
            margin-left: 0 !important;
            width: 100% !important;
        }
        /* Book reader text adjust */
        .book-reader {
    ...
    /* Extra small devices (under 400px) – even smaller */
...
# ─── FORCE MOBILE FIX (overrides any previous styling) ──────────────
st.markdown("""
<style>
/* THIS BLOCK FORCES MOBILE LAYOUT – DO NOT REMOVE */
@media (max-width: 768px) {
    /* Force all columns to stay in a row */
    .row-widget.stColumns {
        flex-wrap: nowrap !important;
    }
    .row-widget.stColumns > div {
    ...
    /* Dashboard action buttons – make them tiny but side‑by‑side */
    .row-widget.stColumns > div .stButton button {
    ...
    /* Top navigation – stay in a single row with scroll */
    .top-nav {
        flex-wrap: nowrap !important;
        overflow-x: auto !important;
        gap: 2px !important;
    ...
    /* Make all other buttons smaller too */
    .stButton button {
        font-size: 0.65rem !important;
    ...
    h3 { font-size: 0.8rem !important; }
    /* Make sure the main container has no extra padding */
    .main .block-container {
