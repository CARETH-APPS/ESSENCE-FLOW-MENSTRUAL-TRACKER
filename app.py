...
<style>
    ...
    /* ─── FORCE HORIZONTAL LAYOUT ON ALL DEVICES ─── */
    ...
    /* Extra override for dashboard action buttons (4‑col row) */
    .row-widget.stColumns > div .stButton button {
    ...
    /* ULTIMATE OVERRIDE – ensure no wrapping anywhere */
    .stColumns, .row-widget.stColumns {
        flex-wrap: nowrap !important;
    }
    .stColumns > div, .row-widget.stColumns > div {
        flex: 1 1 0 !important;
        min-width: 0 !important;
    }
</style>
