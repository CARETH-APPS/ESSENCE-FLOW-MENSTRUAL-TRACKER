...
<style>
    ...
    /* Make columns stack vertically on mobile and use full width */
    @media (max-width: 768px) {
        ...
        /* Fix metric boxes on mobile */
        .stMetric {
            width: 100% !important;
            text-align: center !important;
        }
        /* Fix top navigation buttons on mobile */
        .top-nav {
            gap: 4px !important;
        ...
        /* Fix buttons to be full width on mobile */
        .stButton button {
            width: 100% !important;
        ...
        /* Fix dataframes on mobile - horizontal scroll */
        .stDataFrame {
        ...
        /* Fix expanders on mobile */
        .stExpander {
            width: 100% !important;
        }
        /* Fix number inputs on mobile */
        .stNumberInput {
            width: 100% !important;
        }
        /* Fix select boxes on mobile */
        .stSelectbox {
            width: 100% !important;
        }
        ...
        /* Fix containers and expanders */
        .stContainer {
            width: 100% !important;
        }
        /* Make cards full width */
        .card, .quick-card, .alert-banner {
            width: 100% !important;
            margin: 0.5rem 0 !important;
            padding: 1rem !important;
        }
        /* Fix book reader on mobile */
        .book-reader {
        ...
        /* Fix sidebar menu items on mobile */
    ...
    @media (max-width: 400px) {
        ...
        /* Hide sidebar toggle text on very small screens */
        section[data-testid="stSidebar"] button {
            font-size: 0.7rem !important;
        }
    }
    
    /* Fix Streamlit's native mobile sidebar */
    @media (max-width: 768px) {
...
# ... (all your existing functions: apply_night_mode, database, AI chat, 
# login_screen, register_screen, dashboard, log_period, symptom_tracker, 
# view_history, pregnancy_info, learn_and_books, wellness_insights, 
# calendar_planner, community_stories, private_chat, online_hub, admin_panel, 
# settings_page, mobile_top_nav, main, etc.)

# ───────────────── ALL YOUR EXISTING FUNCTIONS GO HERE ─────────────────
# (Keep everything below exactly as it was – I have not changed any 
#  of your functions, logic, or database code. Only the CSS above was enhanced.)
